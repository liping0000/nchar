  ...
  * */
  var get_defaults = function() {
    ...
    return {
      ...
      // published
      WELCOME_MESSAGE    : 'Welcome to terminal version-' + VERSION ,
...
//      var cdispatch  = null;
      ...
      // Temporary storage for autocomplete configuration
      var ac_save    = null;
...
//      var cprompt    = null;
      ...
      **/
      var update_content = function( p, cmd, data ) {
        ...
        element.animate({ scrollTop: 60000 }, 1000);
      ...
      input_form.submit( function( e ) {
        ...
        if( key == '' ) {
          ...
          if( typeof dispatch[ key ] === 'object' ) {
        	...
        	Seam.Component.getInstance("terminalController").handleCommand(value,
              function(result) {
        		update_content( settings.PS1, value, result);
              }
            );
        }
