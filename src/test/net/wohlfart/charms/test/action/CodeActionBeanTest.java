...
public class CodeActionBeanTest extends AbstractTranslateableActionBase {
    ...
    public void begin() {
        ...
        abstractEntityHome = (ChangeRequestCodeHome) Component.getInstance("changeRequestCodeHome");
    ...
    public void testCreateAction() {
        ...
        final ChangeRequestCodeHome home = (ChangeRequestCodeHome) abstractEntityHome;

        outcome = home.setEntityId(null);
        assert "valid".equals(outcome) : "error setting entityId to null for creatig a new entity";
        // calling the factory method
        final ChangeRequestCode entity = home.getInstance();

        // simulate some user entries:
        entity.setDefaultName("code1");
        entity.setEnabled(true);
        home.persist();

        final Long id = home.getInstance().getId();
        assert id != null : "persisted error has null id ";
    ...
    public void testNameCollisionAction() {
        ...
        // calling the factory method
        final ChangeRequestCode entity1 = home.getInstance();
        ...
        outcome = home.setEntityId(null);
        Assert.assertEquals(outcome, "valid", "error setting entityId to null for creatig a new entity");
        ChangeRequestCode entity2 = home.getInstance();
