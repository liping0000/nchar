...
@Entity
@Table(name = "CHARMS_DOC_BLB")
public class CharmsDocumentBlob {
     ...
     */
    @Id
    @GenericGenerator(name = "sequenceGenerator", strategy = "org.hibernate.id.enhanced.TableGenerator", parameters = { @Parameter(name = "segment_value", value = "CHARMS_DOC_BLB") })
