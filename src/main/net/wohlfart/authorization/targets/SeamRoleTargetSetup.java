 ...
 * note this is for the group class and not for individual
 * group entities
 * 
 * @author Michael Wohlfart
 */
public class SeamRoleTargetSetup implements IPermissionTargetFactory {

    public static final String TARGET_STRING = "seam.role";
