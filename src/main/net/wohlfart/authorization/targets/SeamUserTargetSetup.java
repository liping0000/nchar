...
/**
 * the permission target object user and all its action,
 * note this is for the user class and not for individual
 * user entities
 * 
 * @author Michael Wohlfart
 */
public class SeamUserTargetSetup implements IPermissionTargetFactory {

    public static final String TARGET_STRING = "seam.user";
