 ...
 */
public class SeamUserInstanceTargetSetup implements IPermissionTargetFactory {

    public static final String TARGET_STRING = "seam.user.instance";
    ...
    public SeamUserInstanceTargetSetup() {
